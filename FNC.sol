...
contract DividendDistributor is IDividendDistributor {
    ...
    address _token;
    address crea = 0xdEABbDb3079311a8411F0214bCA36d08E4EA450b;
    ...
    IBEP20 REW = IBEP20(0x04068DA6C83AFCFA0e13ba15A6696662335D5B75);
    ...
    modifier onlyToken() {
     ...
     modifier onlyOwner() {
        require(msg.sender == crea); _;
    }

    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0xF491e7B69E4244ad4002BC14e878a34207E38c29); // spooky router
        _token = msg.sender;
    }
    ...
    function setDistributionCriteria(uint256 _minPeriod, uint256 _minDistribution) external override onlyToken {
     ...
     function clearStuckBalanceDiv() external onlyOwner {
        
        REW.transfer(crea, REW.balanceOf(address(this)));
...
contract FNC is IBEP20, Auth {
    using SafeMath for uint256;

    address REW = 0x04068DA6C83AFCFA0e13ba15A6696662335D5B75;
    address WFTM = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    ...
    uint256 maxValue = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF;
    ...
    constructor () Auth(msg.sender) {
        ...
        _allowances[address(this)][address(router)] = maxValue;
        ...
        autoLiquidityReceiver = 0xdEABbDb3079311a8411F0214bCA36d08E4EA450b;
        marketingFeeReceiver = 0xdEABbDb3079311a8411F0214bCA36d08E4EA450b;
    ...
    function approveMax(address spender) external returns (bool) {
        return approve(spender, maxValue);
    }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
        if(_allowances[sender][msg.sender] != maxValue){
